  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 50% 60% at 50% 50%, #161616 0%, #0f0f0f 40%, transparent 70%)',
        }}
        aria-hidden
      />
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 50% 60% at 80% 20%, #181818 0%, #0f0f0f 45%, transparent 70%)',
        }}
        aria-hidden
      />
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 55% 55% at 50% 50%, #161616 0%, #0d0d0d 50%, transparent 75%)',
        }}
        aria-hidden
      />
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 50% 50% at 20% 80%, #161616 0%, #0f0f0f 45%, transparent 70%)',
        }}
        aria-hidden
      />
    </div>
