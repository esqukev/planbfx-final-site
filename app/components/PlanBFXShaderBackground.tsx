...
void main() {
  ...
  vec3 col1 = vec3(0.949, 0.561, 0.792);  // rgb(242,143,202)
  vec3 col2 = vec3(0.463, 0.169, 0.690);  // rgb(118,43,176)
...
export default function PlanBFXShaderBackground() {
